  ...
  const card=cards.find(card => card.id ===idInt )
    ...
    return (
        <div  className="w-[1300px] m-auto mb-10">
            <img  className="w-fit lg:w-[1320px] m-auto h-[700px] lg:mt-10" src={card.image} alt="" />
            <div className="absolute bottom-1 top-[700px] p-4 bg-slate-500 w-[1300px] bg-opacity-40 h-32">
